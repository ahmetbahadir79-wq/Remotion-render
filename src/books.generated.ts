...
import cfg_all_the_light_we_cannot_see from '../books/all-the-light-we-cannot-see/config.vox.json';
import meta_all_the_light_we_cannot_see from '../books/all-the-light-we-cannot-see/youtube-meta.json';
...
export const BOOK_PALETTES: Record<string, Palette> = {
  ...
  'stolen-focus': { paper: '#F6F5EF', ink: '#14161A', red: '#B91C1C', gold: '#D97706' },
  ...
  'the-southern-book-club-s-guide-to-slaying-vampires': { paper: '#FAF7F2', ink: '#1A1412', red: '#8B1A1A', gold: '#C4973B' },
...
export const BOOKS: BookEntry[] = [
  {
    ...
    engine: 'vox',
    config: cfg_all_the_light_we_cannot_see as any,
    meta: meta_all_the_light_we_cannot_see as any,
  },
  {
    slug: 'dust',
    engine: 'vox',
...
export const ANTIDOTE_BOOKS: AntidoteBookEntry[] = [
  ...
  },
  {
    slug: 'fahrenheit-451',
    engine: 'antidote',
    config: ant_fahrenheit_451 as any,
    meta: ant_meta_fahrenheit_451 as any,
  },
  {
  ...
  },
  {
    ...
    engine: 'antidote',
    config: ant_the_courage_to_be_disliked as any,
  ...
  },
  {
    ...
    engine: 'antidote',
    config: ant_the_southern_book_club_s_guide_to_slaying_vampires as any,
    meta: ant_meta_the_southern_book_club_s_guide_to_slaying_vampires as any,
  },
  {
    slug: 'unhinged',
    engine: 'antidote',
    config: ant_unhinged as any,
    meta: null,
  },
  {
    slug: 'we-were-liars',
